<?php include('header.php'); ?>
		...
		<!-- /search-popup -->
					...
					<div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="about-content s-about-content  wow fadeInRight  animated" data-animation="fadeInRight" data-delay=".4s">
                                <div class="about-title second-title pb-20">  
                                    <h5>01. About Us</h5>
                                    <h2>We Develop Qulity Project Since 1988</h2>
                                   
                                </div>
                                
                                <p>Nulla et sapien felis. Cras ex sapien, eleifend ac orci id, maximus aliquet ipsum. Duis in maximus nisl. Curabitur vitae mi fermentum, ullamcorper turpis arcu.</p>
                               <div class="about-content3 mb-25">
                                    <div class="row">
                                    <div class="col-md-12">
                                     <ul class="green">                                              
                                                <li>Duis semper, nisi eget accumsan cursus, nisl ligula sagittis ex at convallis.</li>
                                                <li>Pellentesque metus turpis, efficitur at turpis semper.</li>     
                                                <li>Curabitur efficitur et massa in elementum.</li>
                                                <li>Morbi gravida sit amet sem a pharetra.</li> 
                                           </ul>
                                    </div>
                                ...
                                <div class="about-gallery">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           <img src="img/features/about_img3.png" alt="img">    
                                        </div>
                                        <div class="col-md-4">
                                           <img src="img/features/about_img4.png" alt="img">    
                                        </div>
            ...
            <section id="video" class="video-area pt-60 pb-60 p-relative" style="background-image:url('<?php echo $pic;?>'); background-repeat: no-repeat; background-position: center bottom; background-size:cover;">
                 <!-- Lines -->
                            <div class="content-lines-wrapper2">
                                <div class="content-lines-inner2">
                                    <div class="content-lines2"></div>
           ...
           <!-- testimonial-area -->
            <section class="testimonial-area pt-120 pb-90">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="testimonial-active">
                                <div class="single-testimonial">
                                   <div class="testi-author">
                                    ...
                                    <p>“Cras sollicitudin leo sed interdum lacinia. Duis dignissim, arcu nec aliquet venentest atis, arcu dolor tempor lorem, sed eleifend urna enim in nunc”.</p>
                                     <div class="qt-img">
                            ...
                            <div class="single-team mb-30 ">
                                <div class="team-thumb p-relative">
                                  <div class="brd">
                                    ...
                                    <div class="dropdown">
                                      <a href="#" class="xbtn"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        +
                                      </a>
                                ...
                                <div class="team-info">
                                     <div class="text">
                                        <h4><a href="team-details.html">James Grady</a></h4>
                                        <span>Founder</span>
                                    </div>
